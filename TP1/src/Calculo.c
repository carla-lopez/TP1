...
/** \brief Esta función sirve para que sume A y B y tambien que muestre el resultado de A + B.
 *
...
/** \brief Esta función sirve para que reste A y B y tambien que muestre el resultado de A - B.
 *
 * \param A: tiene un numero flotante.
 * \param B: tiene un numero flotante.
...
/** \brief Esta función sirve para que divida A y B y que muestre el resultado de A / B.
 *
 * \param A: tiene un numero flotante.
 * \param B: tiene un numero flotante.
...
/** \brief Esta función sirve para que multiplique A y B y tambien que muestre el resultado de A * B.
 *
 * \param A: tiene un numero flotante.
 * \param B: tiene un numero flotante.
...
/** \brief Esta función sirve para que factorice A y que muestre el resultado de A!.
 *
...
/** \brief Esta función sirve para que factorice B y que muestre el resultado de B!.
 *
 * \param A: tiene un numero entero.
 * \param B: tiene un numero entero.
